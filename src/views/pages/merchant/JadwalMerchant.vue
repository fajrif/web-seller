...
const arrayTime = ["06:00", "07:00", "08:00", "09:00",
...
const { data: scheduleDetails } = await useApiRails("/merchant/operational_hour")
...
const saveSchedule = async dataSchedule => {
	try {
		await $apiRails("/merchant/operational_hour", {
			method: 'PUT',
